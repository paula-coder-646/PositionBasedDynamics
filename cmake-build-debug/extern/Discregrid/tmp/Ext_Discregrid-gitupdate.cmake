...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "4c27e1cc88be828c6ac5b8a05759ac7e01cf79e9"
  WORKING_DIRECTORY "/home/paula/Desktop/PBD/PositionBasedDynamics/cmake-build-debug/extern/Discregrid/src/Ext_Discregrid"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "4c27e1cc88be828c6ac5b8a05759ac7e01cf79e9")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("4c27e1cc88be828c6ac5b8a05759ac7e01cf79e9" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/4c27e1cc88be828c6ac5b8a05759ac7e01cf79e9")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"4c27e1cc88be828c6ac5b8a05759ac7e01cf79e9\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/paula/Desktop/PBD/PositionBasedDynamics/cmake-build-debug/extern/Discregrid/src/Ext_Discregrid'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/paula/Desktop/PBD/PositionBasedDynamics/cmake-build-debug/extern/Discregrid/src/Ext_Discregrid'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
